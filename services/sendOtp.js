...
//managing  the otp forgot
export const sendOtpForgot = async ({
  username,
  password,
  email,
  subject,
...
//sending auto generated email
export const sendAutoEmailDoctor = async ({
  email,
  subject,
  message,
  name,
