...
router.post('/add_banner', verifyAdmin,addBanner)
router.post('/update_banner',  verifyAdmin,updateBanner)
router.get('/get_banners', getBanner)
router.get('/get_specialities', getSpecialities)
router.delete('/delete_specialities/:id', verifyAdmin, deleteSpecialities)
router.post('/add_specialities',  verifyAdmin,addSpecialities)
